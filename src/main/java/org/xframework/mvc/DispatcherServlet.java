 ...
 * 前端控制器
 * @author HuHui
 * @version $Id: DispatcherServlet.java, v 0.1 2017年4月20日 下午8:24:24 HuHui Exp $
 */
@WebServlet(urlPatterns = "/*", loadOnStartup = 0)
public class DispatcherServlet extends HttpServlet {

    /**  */
    private static final long        serialVersionUID         = -6213658013494222755L;
    ...
    public void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LogUtil.info(logger, "{0}:{1}", currentRequestMethod, currentRequestPath);
        //将"/"请求重定向到首页
