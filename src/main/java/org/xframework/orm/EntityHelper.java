...
import org.xframework.orm.annotation.Column;
import org.xframework.orm.annotation.Entity;
import org.xframework.orm.annotation.Table;
import org.xframework.util.StringUtil;

/**
 * 初始化Entity结构
 * @author HuHui
 * @version $Id: EntityHelper.java, v 0.1 2017年5月1日 下午4:20:18 HuHui Exp $
 */
public class EntityHelper {
    ...
    public static Map<String, String> getColumnMap(Class<?> entityClass) {
        return new LinkedHashMap<String, String>(getFieldMap(entityClass));
    }
